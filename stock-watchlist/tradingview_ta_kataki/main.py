# Tradingview Technical Analysis (tradingview-ta_kataki)
# Original Author: deathlyface (https://github.com/deathlyface)
# Author of this fork: KatakiTakanashi (https://github.com/Kataki-Takanashi)
# License: MIT
...
class TradingView:
    ...
    indicators = ['Recommend.Other', 'Recommend.All', 'Recommend.MA', 'RSI', 'RSI[1]', 'Stoch.K', 'Stoch.D', 'Stoch'
                                                                                                             '.K[1]',
                  'Stoch.D[1]', 'CCI20', 'CCI20[1]', 'ADX', 'ADX+DI', 'ADX-DI', 'ADX+DI[1]', 'ADX-DI[1]', 'AO',
                  'AO[1]', 'Mom', 'Mom[1]', 'MACD.macd', 'MACD.signal', 'Rec.Stoch.RSI', 'Stoch.RSI.K', 'Rec.WR',
                  'W.R', 'Rec.BBPower', 'BBPower', 'Rec.UO', 'UO', 'close', 'EMA5', 'SMA5', 'EMA10', 'SMA10',
                  'EMA20', 'SMA20', 'EMA30', 'SMA30', 'EMA50', 'SMA50', 'EMA100', 'SMA100', 'EMA200', 'SMA200',
                  ...
                  'BB.upper', 'AO[2]', 'volume', 'change', 'low', 'high', 'VWAP', 'gap', 'SMA9', 'change_abs',
                  'High.1M', 'Low.1M', 'High.3M', 'Low.3M', 'Perf.3M', 'price_52_week_high', 'price_52_week_low',
                  'High.6M', 'Low.6M', 'Perf.6M', 'High.All', 'Low.All', 'Aroon.Down', 'Aroon.Up', 'ADR', 'ATR',
                  'average_volume_10d_calc', 'Perf.Y', 'Perf.YTD', 'average_volume_30d_calc',
                  'average_volume_60d_calc', 'average_volume_90d_calc', 'change_from_open_abs', 'change_from_open',
                  'DonchCh20.Lower', 'DonchCh20.Upper', 'Ichimoku.CLine', 'Ichimoku.Lead1', 'Ichimoku.Lead2',
                  'KltChnl.lower', 'KltChnl.upper', 'Perf.1M', 'ROC', 'RSI7', 'relative_volume_10d_calc',
                  'Stoch.RSI.D', 'Volatility.D', 'Volatility.M', 'Volatility.W', 'Perf.W', 'update_mode',
                  ...
                  'Candle.TriStar.Bearish', 'Candle.TriStar.Bullish', 'RSI7', 'RSI7[1]']
...
class TA_Handler(object):
    ...
    def get_indicators(self, indicators=[]):
        ...
        if self.screener == "" or type(self.screener) != str:
            raise Exception("Invalid Screener")
        ...
        headers = {"User-Agent": "tradingview_ta_kataki/{}".format(__version__)}
